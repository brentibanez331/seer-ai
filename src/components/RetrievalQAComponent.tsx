...
export const RetrievalQAComponent = ({ node, onMouseEnterInput, onMouseLeaveInput, onMouseDownOutput, selected, x, y, onMouseDownNode }: NodeProps) => {
    ...
    return (
        ...
        >
            <div className="text-xs px-2 py-2 space-y-6">
                <h2 className="text-md font-bold">Retrieval QA Chain</h2>
                {/* A Text + Node Input */}
                    ...
                    <div className="relative">
                        <div className="input-wrapper">
                            <div
                                ...
                                ref={(el) => { }}
                                className="input"
                                onMouseEnter={(event) => handleMouseEnterInput(event.currentTarget, 'retriever')}
                                onMouseLeave={() => handleMouseLeaveInput('retriever')}
                            >
                            </div>
                        </div>
                        <p className="text-neutral-400">Retriever</p>
                    </div>
